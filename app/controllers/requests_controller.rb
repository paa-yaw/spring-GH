...
def request_params
  params.require(:request).permit({:weekdays=>[]}, {:extra_services=>[]}, :date, :frequency, :bathrooms, :bedrooms, :hall, :kitchens, :email, :phone_number, :location, :terms, :total_rooms, :total_cost, :referral_code, :promocode, :status, :time)
end
end
